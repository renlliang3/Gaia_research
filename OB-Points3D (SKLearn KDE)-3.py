...
rel_path = "Data/A_corrected_mean_AG_EBminR_xyz.fits"
...
mlab.contour3d(X, Y, Z, dens, contours=[5*10**-9,5.5*10**-9,6*10**-9,7*10**-9,8*10**-9,10*10**-9,12*10**-9], opacity=0.3, vmin=np.min(dens), vmax=np.max(dens), colormap = 'Blues', figure = figure)
