...
AND g.bp_rp - g.e_bp_min_rp_val >= 1.93 \
AND g.bp_rp - g.e_bp_min_rp_val <= 3.94 \
AND g.phot_g_mean_mag + 5 * log10(g.parallax) - 10 - g.a_g_val >= 8.2 \
AND g.phot_g_mean_mag + 5 * log10(g.parallax) - 10 - g.a_g_val <= 17.3 \
