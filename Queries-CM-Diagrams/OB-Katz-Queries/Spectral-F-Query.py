...
AND g.bp_rp - g.e_bp_min_rp_val >= 0.38 \
AND g.bp_rp - g.e_bp_min_rp_val <= 0.72 \
AND g.phot_g_mean_mag + 5 * log10(g.parallax) - 10 - g.a_g_val >= 2.5 \
AND g.phot_g_mean_mag + 5 * log10(g.parallax) - 10 - g.a_g_val <= 4.0 \
