...
AND g.bp_rp - g.e_bp_min_rp_val >= 0.99 \
AND g.bp_rp - g.e_bp_min_rp_val <= 1.87 \
AND g.phot_g_mean_mag + 5 * log10(g.parallax) - 10 - g.a_g_val >= 5.6 \
AND g.phot_g_mean_mag + 5 * log10(g.parallax) - 10 - g.a_g_val <= 8.1 \
